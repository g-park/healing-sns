...
import com.garamsoft.bubble.service.ServiceToHome;
...
//		private int count = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_wanning_info_layout);
		...
		textViewCalendar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				PendingIntent pendingIntent = PendingIntent.getService(
						getApplicationContext(), 305, intent,
...
//				}
				...
				if (componentName != null) {
				    ...
				    try{
				    	...
				    	Toast.makeText(mContext, "캘린더 앱이 없거나 알 수 없는 에러가 발생했습니다.", 0).show();
					}
...
//				textViewLocationName.setText(str_live);
				defaultLiveManager.writeLive(str_live);
				...
				liveList.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> arg0, View view,
						...
						if (position == 2 || position == 5 || position == 6
							...
							str_live = liveList.getItemAtPosition(position)
									.toString();
...
//							textViewLocationName.setText(str_live);
				...
				return new AlertDialog.Builder(ActivityInfo.this)
